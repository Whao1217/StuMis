...
<body>
	...
	<div align="center">
	    <h1 style="color: black;">&nbsp&nbsp&nbsp欢迎进行学生信息添加！</h1>
		...
		<table border="6">
			...
			<tr>
            	...
            	<td><input type="text" name="birthday" id="birthday"required  placeholder="请输入出生日期" onblur="checkBirthday(this.value)" ><span id="span3"></span></td>
			</tr>
			<tr>
